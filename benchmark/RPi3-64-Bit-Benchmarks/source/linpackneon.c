/*
 ...
 gcc-6  linpackneon.c cpuidc.c -lm -lrt -O3 -march=armv8-a -o linpackPiNEONi64
 #define options   " Using NEON Intrinsics"

 daxpy intrinsics (see #ifdef NEON) compiled as:
...
main (int argc, char *argv[])
{
       ...
       #ifdef GCCARM64SP
        sprintf(expect[0], "             2.0");
        sprintf(expect[1], "  4.69621336e-05");
        sprintf(expect[2], "  1.19209290e-07");
        sprintf(expect[3], " -1.31130219e-05");
        sprintf(expect[4], " -1.30534172e-05");
       #endif
