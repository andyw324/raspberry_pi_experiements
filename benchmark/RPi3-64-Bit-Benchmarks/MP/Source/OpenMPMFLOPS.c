...
Affinity Setting
taskset 0x00000001 ./OpenMP-MFLOPS64

 gcc-6 OpenMPMFLOPS.c cpuidc.c -lm -lrt -O3 -fopenmp -march=armv8-a -o OpenMP-MFLOPS64 
 char   heading[40]  = "OpenMP MFLOPS64";
 gcc-6 OpenMPMFLOPS.c cpuidc.c -lm -lrt -O3 -march=armv8-a -o notOpenMP-MFLOPS64 
 char   heading[40]  = "notOpenMP MFLOPS64";
