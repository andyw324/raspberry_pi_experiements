/*
gcc-6 memSpeedOMP.c cpuidc.c -lrt -lc -lm -O3 -march=armv8-a -fopenmp -o OpenMP-MemSpeed264
gcc-6 memSpeedOMP.c cpuidc.c -lrt -lc -lm -O3 -march=armv8-a -o NotOpenMP-MemSpeed264

Affinity Setting
taskset 0x00000001 ./OpenMP-MemSpeed264
...
//  #define Integer64Bits
 ...
 // #define version  "notOpenMP 64 Bit"
  #define version  "OpenMP 64 Bit"
