/*
 ...
 taskset 0x00000001 ./MP-MFLOPSPi64DP

 gcc-6 mpmflopsdp.c cpuidc.c -lm -lrt -O3 -lpthread -march=armv8-a -o MP-MFLOPSPi64DP 
 #define version  "armv8 64Bit Double Precision"
