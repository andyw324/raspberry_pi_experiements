...
// Compile command -  gcc RPiHeatMHzG.c -lrt -o RPiHeatMHz64G

// Run     command -  ./RPiHeatMHz64G passes ppp, seconds sss

//                    for ppp samples at sss second intervals

// Default            ./RPiHeatMHz64G
...
void getTemperature()
{
    ...
    int s = system("sudo vcgencmd measure_clock arm > MH.txt");
    ...
    int g = system("sudo vcgencmd measure_temp >> RPiHeatMHz.txt");
    int h = system("sudo vcgencmd measure_temp");
    return;
}
